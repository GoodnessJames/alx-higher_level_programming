...
This project focused on honing skills related to file input/output (I/O) in Node.js
and leveraging the NPM (Node Package Manager) 'request' framework to interact with
the APIs of [Star Wars](https://swapi.co/) and [JSONplaceholder](https://jsonplaceholder.typicode.com).
