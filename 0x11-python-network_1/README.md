# Python - Network #1
This project entailed acquiring proficiency in utilizing the `urllib` and `requests`
libraries in Python 3 for transmitting and retrieving HTTP messages from URLs. It
involved practical experience in sending both `GET` and `POST` requests, retrieving
JSON resources, and engaging with various APIs, including the  GitHub API.

## Project Tasks

* **0. What's my status? #0**
  * [0-hbtn_status.py](./0-hbtn_status.py): Python script that fetches
  `https://alx-ntranet.hbtn.io/status`.
  * Uses `urllib`.
