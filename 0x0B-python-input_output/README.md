# Python - Input/Output
In this project, I gained practical experience in Python file handling. I effectively utilized
built-in functions such as `with`, `open`, and `read`, in conjunction with the `json` module.
This allowed me to proficiently read and write files, as well as perform serialization and
deserialization of objects using JSON formatting.

## Description of the Project Files

* [tests](./tests): Folder of test files povided by ALX SE School.
