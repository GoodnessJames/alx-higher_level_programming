...
In this project, I demonstrated proficiency in Python object-oriented programming
by implementing three interconnected classes to depict rectangles and squares.
...
* [tests](./tests): Folder containing the following independently-developed
test files:
