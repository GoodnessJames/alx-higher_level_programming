# SQL - Introduction
This project marked my initial foray into working with SQL and relational databases.
It served as the starting point for my exploration of introductory data definition
